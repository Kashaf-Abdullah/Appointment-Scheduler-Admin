...
const Adminpage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(`${process.env.REACT_APP_API_BASE_URL}/media/add/`, formData)
      .then(res => {
        // console.log(res);
  ...
  const handleDelete = (postId) => {
    ...
    axios
      .delete(`${process.env.REACT_APP_API_BASE_URL}/media/delete/${postId}`)
      .then((response) => {
  ...
  const handleUpdate = (postId, updatedData) => {
    ...
    axios.put(`${process.env.REACT_APP_API_BASE_URL}/media/update/${postId}`, formData)
        .then(res => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_BASE_URL}/media/allpost`)
      .then((response) => {
