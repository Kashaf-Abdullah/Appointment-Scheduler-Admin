...
const Consulting = () => {
  ...
  useEffect(() => {
    const fetchSpecialDates = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/api/schedules`);
...
const [selectedTime, setSelectedTime] = useState(null);
  ...
  const fetchSchedules = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/api/schedulemeeting`);
  ...
  const confirmSubmit = async () => {
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/schedulemeeting`, formData);
  ...
  const sendEmailNotification = async (formData) => {
    try {
      const response = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/sendEmail`, formData);
      ...
      <div className="votrags-det" style={{ marginTop: "1.9rem" }}>
        <div className="row">
          <div className="col-lg-6 col-md-6 col-sm-6">
           <p className="text">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero molestias excepturi possimus cum consequatur! Neque? Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis sunt nulla quae.
           </p>
            ...
            {visible && (
              ...
              <div style={containerStyle}>
                <div style={sectionStyle}>
                  ...
                  <h6 className="calender-left"> Lorem ipsum dolor sit amet.
                  </h6>
